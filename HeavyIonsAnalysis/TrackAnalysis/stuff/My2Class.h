...
#ifdef My2Class_cxx
My2Class::My2Class(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("primary_2018B_merger.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("primary_2018B_merger.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("primary_2018B_merger.root:/analyzer");
...
Int_t My2Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t My2Class::LoadTree(Long64_t entry)
{
...
void My2Class::Show(Long64_t entry)
{
...
Int_t My2Class::Cut(Long64_t entry)
{
