...
void MyClass::Loop(int job){
    ...
    TFile* fS_tempA = new TFile(Form("src/paper/P470_Gen/Primary/Primary_job%d.root",job), "recreate");
    ...
    TFile* fS_tempB = new TFile(Form("src/paper/P470_Gen/Secondary/Secondary_job%d.root",job), "recreate");
    for(int wtrk =1; wtrk <trackbin+1; wtrk++){
