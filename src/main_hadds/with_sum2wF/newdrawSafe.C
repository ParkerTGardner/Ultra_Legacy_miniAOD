...
void newdraw()
{
    TFile *f1 = new TFile("SumPall.root");
    TFile *f2 = new TFile("MC_Full470_F.root");
    TFile *f3 = new TFile("MC_FullHerwig.root");
...
////////////////////////
        ...
        cA[wtrk]->cd(1);
        Fitter(hSS1,hBS1,28,34,2, 1);       
        Fitter(hSC1,hBC1,27,34,3, 2);       
        Fitter(hSC1,hBC1,28,34,4, 2);       

        cA[wtrk]->cd(2);
        Fitter(hSS2,hBS2,28,34,2, 1);       
        Fitter(hSC2,hBC2,27,34,3, 2);       
        Fitter(hSC2,hBC2,28,34,4, 2);       

        cA[wtrk]->cd(3);
        Fitter(hSS3,hBS3,28,34,2, 1);       
        Fitter(hSC3,hBC3,27,34,3, 2);       
        Fitter(hSC3,hBC3,28,34,4, 2);       
