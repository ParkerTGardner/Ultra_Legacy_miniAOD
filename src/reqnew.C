...
void reqnew()
{
    ...
    //int YPlow = floor(0.6875*YPmax);

    int ii = 1;
    int LLow = floor((5.0/8.0)*YPmax);
    int HHi  = floor((7.5/8.0)*YPmax);
    ...
    //TF1 *fv1 = new TF1("fv1","([0]*TMath::Cos(x))"  ,0,3.14157);
    //TF1 *fv2 = new TF1("fv2","([0]*TMath::Cos(2*x))",0,3.14157);
    //TF1 *fv3 = new TF1("fv3","([0]*TMath::Cos(3*x))",0,3.14157);
    /*
